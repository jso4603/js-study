...
// // 4) Constants => 값을 할당한 뒤로는 값을 변경할 수 없다.
...
// // 6) number : javascript는 값에 상관없이 숫자면 type을 number로 할당한다.
...
// // 8) bigInt : javascript의 최대 숫자 이상을 사용할 수 있다.(크롬, 사파리만 이용 가능)
// //             숫자 뒤에 n을 붙여서 사용한다.
